      ...
      <div className="bg-background rounded-xl border border-border overflow-hidden">
        {loading ? (
          ...
          <div className="flex flex-col items-center gap-4 py-16 text-foreground-muted">
            <Layers size={44} className="opacity-25" />
            <div className="text-center">
              <p className="font-semibold text-foreground text-lg">No brands</p>
                  ...
                  >
                      ...
                      <div className="flex items-center gap-3">
                        {brand.logo ? (
                          <img
                            src={brand.logo}
                            alt={brand.name}
                            className="w-8 h-8 rounded-lg object-contain border border-border bg-background-subtle p-0.5"
                          />
                        ) : (
                          <div className="w-8 h-8 rounded-lg border border-border bg-background-subtle flex items-center justify-center text-foreground-muted">
                            <Layers size={14} />
                          </div>
                        )}
                    ...
                    <td className="px-5 py-3.5">
                      <button
                        ...
                        className={cn(
                          "transition-colors",
                          brand.isActive ? "text-emerald-500" : "text-foreground-muted"
                        )}
