  ...
  useEffect(() => {
    const fetchAll = async () => {
      ...
      try {
        ...
        const catsData: { categories?: ServiceCategory[] } = catsRes.ok ? await catsRes.json() : {};
        ...
        setForm({
          ...
          requiresOnsite: service.requiresOnsite ?? false,
    ...
    <div className="max-w-3xl mx-auto space-y-8">
      ...
      <form onSubmit={handleSubmit} noValidate className="space-y-8">
        ...
        <section className="card-premium rounded-2xl p-6 space-y-5">
          ...
          <Field label="Slug" required hint="Used in the service URL.">
            <input
              type="text"
              value={form.slug}
